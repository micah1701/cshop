...
$colmap = array('cm_products_relations' => array('Related Products', 'checkarray', null, array('size'=>15), false));
...
if (isset($_POST['f_op']) and ($ACTION == OP_EDIT)) {
    ...
    if ($errs = $mosh->check_form($colmap)) {
        ...
        if (!count($errs)) {
            ...
            if (!isset($vals['cm_products_relations'])) {
                $vals['cm_products_relations'] = array();
            }
