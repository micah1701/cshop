-- MySQL dump 10.9
--
-- Host: localhost    Database: shopalicom
-- ------------------------------------------------------
...
CREATE TABLE `cm_news` (
  ...
  PRIMARY KEY  (`id`)
) TYPE=InnoDB COMMENT='functional news table';
...
CREATE TABLE `cm_products` (
  ...
  `fight_era` varchar(255) NOT NULL default '',
  `description2` text,
  `story` text,
  `short_desc` varchar(255) default NULL,
  `stock_msg` varchar(255) default NULL,
  `shipping_msg` varchar(255) default NULL,
  PRIMARY KEY  (`id`),
