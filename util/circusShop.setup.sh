...
echo "WELCOME TO cShop INSTALLER v.0.3"
...
cd ../../web/control/
ln -s ../../local/circusShop/control cshop
...
cd ../../templates/
ln -s ../local/circusShop/templates cart
...
echo "==> creating config/circusShop.config.php config file ========="
if [ -f $CSHOP_BASEDIR/../config/circusShop.config.php ]; then
    echo "file exists, skipping"
else 
    cp $CSHOP_BASEDIR/samples/circusShop.config.php $CSHOP_BASEDIR/../../config/circusShop.config.php
fi
...
# auto-generated by circusShop.setup.sh
...
echo 'Smarty onsetlib authlib circusShop' > .cvsignore
